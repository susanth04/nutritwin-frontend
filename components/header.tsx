  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex items-center justify-between h-16 px-4 mx-auto max-w-7xl">
        ...
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="icon" asChild className="hover:bg-emerald-50 dark:hover:bg-emerald-950">
            <a href="https://github.com/susanth04/Personalised-nutrition-planner" target="_blank" rel="noopener noreferrer" aria-label="View source on GitHub">
